...
<body onLoad="updateCart()">
	...
	<div class="shopping-cart-container">
		<c:if
			test="${not empty cartForm and not empty cartForm.cartLineInfos}">
			<form:form method="POST" id="cartForm" modelAttribute="cartForm"
				action="${contextPath}/shoppingCart">
				<div class="product-shoppingcart-preview-container">
					<table>
						...
						<c:forEach items="${cartForm.cartLineInfos}" var="cartLineInfo"
							varStatus="varStatus">
							<tr>
								<td><img class="product-image"
									src="${contextPath}/productImage?code=${cartLineInfo.productInfo.code}" /></td>
								<td style="display: none">Code:
									${cartLineInfo.productInfo.code} <form:hidden
										path="cartLineInfos[${varStatus.index}].productInfo.code" />
								</td>
								...
								<td><a
									href="${contextPath}/shoppingCartRemoveProduct?code=${cartLineInfo.productInfo.code}"><i
										class="fa fa-trash-o" style="font-size: 24px; color: red"></i>
								</a></td>
							</tr>
						</c:forEach>
					</table>
				...
				<div class="shopping-cart-nav">
					<button class="button-update-product" type="submit"
						value="Update Information">Update Information</button>
					<a class="btn-continue-buy" href="${contextPath}/productList">Continue
						Buy</a> <a class="btn-enter-customer"
						href="${contextPath}/customerInfo">Enter Customer Information</a>
